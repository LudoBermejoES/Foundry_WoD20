...
/**
 * A Precepto's `associated_practices`/`limited_practices` store raw `mage-practices` compendium ids
 * (e.g. "elementalism", "divine-bond") — never a display name. `preparePrismContext` used to join
 * those ids straight into the sheet text, so a player saw the English id instead of the Práctica's
 * own (Spanish) name. Sourced from `wod content entities --line mage --type practice` against the
 * live `wod20-compendium-es` corpus (2026-08-18); keep in sync if a Práctica id is ever renamed there.
 */
export const PRACTICE_NAME_ES = {
	abyssalism: "Abismalismo",
	alchemy: "Alquimia",
	animalism: "Animalismo",
	"app-based-practice": "Práctica Basada en Apps",
	appropriation: "Apropiación",
	"art-of-desire": "El Arte del Deseo / Hipereconomía",
	"art-of-desire-hypereconomics": "Hipereconomía",
	"artemis-gift": "El Don de Ártemis",
	asagwe: "Asagwe",
	authority: "Autoridad",
	bardism: "Bardismo",
	biotech: "Biotecnología",
	bureaucracy: "Burocracia",
	"ceremonial-magick": "Magia Ceremonial",
	"chaos-magick": "Magia del caos",
	charity: "Caridad",
	craftwork: "Artesanía",
	"crazy-wisdom": "Sabiduría loca",
	"cybernetic-reality-hacking": "Piratería de la realidad cibernética",
	cybernetics: "Cibernética",
	demonism: "Demonismo",
	"divine-bond": "Vínculo divino",
	do: "Do",
	dominion: "Dominio",
	elementalism: "Elementalismo",
	ethertech: "Etertecnología",
	faith: "Fe",
	feralism: "Feralismo",
	"gladius-domini": "Gladius Domini",
	goetia: "Goetia",
	"gutter-magick": "Magia callejera",
	harmony: "Armonía",
	"high-ritual-magick": "Alta Magia Ritual",
	hypertech: "Hipertecnología",
	"infernal-sciences": "Ciencias Infernales",
	"integrative-technology": "Tecnología Integradora",
	...
	"medicine-work": "Medicina",
	mediumship: "Mediumnidad",
	nyeredzi: "Nyeredzi",
	occultation: "Ocultación",
	"postmodernism-hacker-analysis": "Posmodernismo/Análisis de Hacker",
	psionics: "Psiónica",
	"qi-manipulation": "Manipulación del Qì",
	"reality-coding": "Codificación de la Realidad",
	"reality-hacking": "Hackeo de la realidad",
	"shadow-work": "Trabajo de Sombra",
	shamanism: "Chamanismo",
	"spirit-ties": "Lazos Espirituales",
	tantra: "Tantra",
	tecknology: "Tecknología",
	"the-black-mass-practice": "La Misa Negra",
	"the-old-ways": "Las Viejas Costumbres",
	"the-royal-art": "El Arte Real",
	"the-scene": "La Escena",
	theosophy: "Teosofía",
	vamamarga: "Vamamarga",
	"viking-martial-arts": "Artes Marciales Vikingas",
	voudoun: "Vudú",
	wayfinding: "Orientación",
	weaving: "Tejido",
	"weird-science": "Ciencia Extraña",
	"wheel-tending": "Cuidado de la Rueda",
	witchcraft: "Brujería",
	yoga: "Yoga"
};
